...
public class activity_data_pembayaran_bangun_dari_awal extends AppCompatActivity {
     ...
     */
    private TextView Nomor_Kontrak, Nama_Pemesan, No_Telp, Pembayaran_1, Pembayaran_2, Pembayaran_3, tgl_1, tgl_2, tgl_3, Status_1, Status_2, Status_3, s_2, s_3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (tgl_2.getText().toString().equalsIgnoreCase("Kosong")) {
            tgl_2.setText("Belum di input");
        } else if (tgl_2.getText().toString().equalsIgnoreCase("")) {
            tgl_2.setText("Belum di input");
        }
        tgl_3.setText(tgl_tiga);
        if (tgl_3.getText().toString().equalsIgnoreCase("Kosong")) {
            tgl_3.setText("Belum di input");
        } else if (tgl_3.getText().toString().equalsIgnoreCase("")) {
            tgl_3.setText("Belum di input");
        }
