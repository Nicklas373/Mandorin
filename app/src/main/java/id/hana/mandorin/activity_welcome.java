...
public class activity_welcome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pref = getApplicationContext().getSharedPreferences("main_welcome", 0);
        String stats = pref.getString("access_from_main", "default");

        if (stats.equalsIgnoreCase("access_from_main")) {
            Toast.makeText(getApplicationContext(), "Memulai Panduan", Toast.LENGTH_SHORT).show();
