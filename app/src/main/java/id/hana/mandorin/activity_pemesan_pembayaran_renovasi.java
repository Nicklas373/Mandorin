...
public class activity_pemesan_pembayaran_renovasi extends AppCompatActivity {

    /*
     * Recyclerview & Data Adapter Initialization
     */
    List<GetDataPembayaranRenovasiAdapter> GetDataAdapter4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pemesan_pembayaran_renovasi);
        ...
        recyclerView2 = findViewById(R.id.recyclerview_pemesan_pembayaran_renovasi);
         ...
         */
        con_text_pemesan_pembayaran_renovasi = findViewById(R.id.con_text_pemesan_pembayaran_renovasi);
        connection_pemesan_pembayaran_renovasi = findViewById(R.id.con_image_pemesan_pembayaran_renovasi);
        refresh_pemesan_pembayaran_renovasi = findViewById(R.id.refresh_pemesan_pembayaran_renovasi);
        back_pemesan_pembayaran_renovasi = findViewById(R.id.back_activity_pemesan_pembayaran_renovasi);
        ...
        back_pemesan_pembayaran_renovasi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(activity_pemesan_pembayaran_renovasi.this, activity_status_pembayaran.class);
    ...
    public void JSON_DATA_WEB_CALL(){
        ...
        String GET_JSON_DATA_HTTP_URL = "http://mandorin.site/mandorin/php/user/read_pembayaran_renovasi.php?email=" + email;
    ...
    public void JSON_PARSE_DATA_AFTER_WEBCALL(JSONArray array){
        ...
        for(int i = 0; i<array.length(); i++) {
            ...
            GetDataPembayaranRenovasiAdapter GetDataAdapter3 = new GetDataPembayaranRenovasiAdapter();
        ...
        recyclerViewadapter2 = new recycler_view_status_pembayaran_renovasi(GetDataAdapter4, this);
