...
public class activity_data_status_bangun extends AppCompatActivity {

    /*
     * Recyclerview & Data Adapter Initialization
     */
    List<GetStatusBangunAdapter> GetDataAdapter4;
    ...
    String JSON_WAKTU_AWAL = "waktu_awal";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_status_bangun_dari_awal);
        ...
        recyclerView2 = findViewById(R.id.recyclerview_status_bangun_dari_awal);
        ...
        back_pemesan_renovasi = findViewById(R.id.back_activity_data_status_bangun_dari_awal);
        ...
        back_pemesan_renovasi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(activity_data_status_bangun.this, activity_kontrak_renovasi.class);
    ...
    public void JSON_DATA_WEB_CALL(){
        ...
        String GET_JSON_DATA_HTTP_URL = "http://mandorin.site/mandorin/php/user/read_status_bangun.php?email=" + email;
    ...
    public void JSON_PARSE_DATA_AFTER_WEBCALL(JSONArray array){
        ...
        for(int i = 0; i<array.length(); i++) {
            ...
            GetStatusBangunAdapter GetDataAdapter3 = new GetStatusBangunAdapter();
            ...
            try {
                ...
                GetDataAdapter3.setWaktu_awal(json.getString(JSON_WAKTU_AWAL));
        ...
        recyclerViewadapter2 = new recycler_view_status_bangun(GetDataAdapter4, this);
