...
public class activity_data_transaksi extends AppCompatActivity {
     ...
     */
    private TextView Id, Nomor_Kontrak, Nama_Pemesan, No_Telp, Biaya_desain, Biaya_konstruksi, Status_satu, Status_dua, Status_tiga, Status_empat, Total_biaya, Tgl_input_satu, Tgl_input_dua, Tgl_input_tiga, Tgl_input_empat, Presentase;
        ...
        if (Status_dua.getText().toString().equalsIgnoreCase("Menunggu")) {
            ...
            if (Presentase.getText().toString().equalsIgnoreCase("80")) {
                ...
                Pembayaran.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Toast.makeText(getApplicationContext(), "Pembayaran ke 2 anda sedang di proses", Toast.LENGTH_SHORT).show();
                    }
                });
            }
